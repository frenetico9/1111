        ...
        <div className="py-12 md:py-20 bg-surface animate-fade-in-up">
            <div className="container mx-auto px-4 sm:px-6">
                <div className="text-center mb-12 md:mb-16">
                    <h1 className="text-3xl md:text-5xl font-bold text-text-dark">Nossos <span className="text-primary-blue">Planos</span></h1>
                    <p className="text-base md:text-lg text-text-light mt-4 max-w-3xl mx-auto">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm text-center min-w-[600px]">
                                <thead className="bg-white">
                                    <tr>
                                        <th className="p-4 md:p-6 text-left text-base md:text-lg font-bold text-text-dark w-[40%] md:w-1/2">Funcionalidades</th>
                                        <th className="p-4 md:p-6 text-base md:text-lg font-bold text-text-dark border-l border-border-color">Grátis</th>
                                        <th className="p-4 md:p-6 text-base md:text-lg font-bold text-primary-blue border-l border-border-color relative">
                                            PRO
