  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-x-hidden">
        <header className="bg-white shadow-sm p-2 md:p-4 sticky top-0 z-20 border-b border-light-blue">
          <div className="flex justify-between items-center max-w-full px-2 sm:px-6 lg:px-8">
            <button className="p-2 text-gray-500 rounded-md md:hidden" onClick={() => setSidebarOpen(true)}>
