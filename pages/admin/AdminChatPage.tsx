            ...
            {activeConversation && (
                 <Modal isOpen={showCallModal} onClose={() => setShowCallModal(false)} title="Informações de Contato" size="sm">
                    <div className="text-center">
                        ...
                        <p className="font-bold text-lg text-primary-blue mb-4">{activeConversation.clientName}</p>
                        <p className="text-2xl font-semibold bg-light-blue p-3 rounded-lg text-text-dark">{activeConversation.clientPhone}</p>
                        <a href={`tel:${activeConversation.clientPhone?.replace(/\D/g, '')}`}>
